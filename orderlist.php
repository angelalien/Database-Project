...
<div id="pricing" class="container-fluid">
  ...
  <div class="row">
		...
		<tr><td>圖片</td><td>商品名稱</td><td>價格</td><td>購買數量</td><td>訂單日期</td></tr>
		<?php
			}
		?>
		<?php 
			$sql= "SELECT c.picture,c.name,c.price,s.quantity,s.time FROM shoppingBag as s,commodity as c WHERE s.cid=c.comid and uid='$uid' and finished=1";
		...
		?>
		<tr><td><img src="picture/<?php echo $r[0]?>" width="15%" height="15%" ></td><td><?php echo $r[1] ?></td><td><?php echo $r[2] ?></td><td><?php echo $r[3] ?></td><td><?php echo $r[4] ?></td></tr>
			<?php }}?>
		</table>
  <div class="row"> 
	<div class="panel-footer">
	<center><input type="button" name="button" value="回首頁" onclick="location.href='home.php'" style="color:#000000;background:#FFB7DD"></center>
	</div>
  </div>
</div>
