...
<div style="text-align:center;margin:0px auto;">
 ...
 <form action="forget_reset_finish.php" method="post">
	...
	if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
			if($new_pw==$new_pw1){
				...
				echo "確認密碼錯誤";
				echo "<script>setTimeout(function(){window.location.href='forget_reset_finish.php';},1500);</script>";
			}
		}
	}else{
		echo "";
