...
if($_SESSION['username'] != null)
{
	...
	$name = $_SESSION['name'];
  $regist_time = $_SESSION['regist_time'];
}
$uid=$_SESSION['id'];
$sql="SELECT a.amount FROM account a, user u WHERE u.id='$uid' AND u.aid=a.aid";
...
<?php $self_intro = $_POST['self_intro']; ?>
...
<div id="portfolio" class="container-fluid text-center">
  ...
  <div class="row text-left">
    ...
    <p><strong>關於我</strong></p>
        <p>姓名&emsp;&emsp;&emsp;&emsp;<?php echo "$name" ?></p>
        <p>性別&emsp;&emsp;&emsp;&emsp;<?php echo "$gender" ?></p>
    <p>信箱&emsp;&emsp;&emsp;&emsp;<?php echo "$username" ?></p>
    <p>現居住地&emsp;&emsp;台灣</p>
    <p>加入日期&emsp;&emsp;<?php echo "$regist_time"?></p>
      </div>
    <?php echo '<a href="logout.php">登出</a>&emsp;<a href="delete.php">刪除</a>&emsp;<a href="resetPassword.php">重設密碼</a>&emsp;' ?>
    <?php echo '<a href="self_intro.php">修改自我介紹</a>' ?>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>自我介紹</strong></p>
    <p><?php echo "$self_intro" ?></p>

      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>信用評價</strong></p>
        <p>目前沒有評價，要有交易才會有評價！</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>帳戶餘額</strong></p>
