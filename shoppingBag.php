<?php
  ...
  $uid=$_SESSION['id'];
  $sql= " SELECT * FROM shoppingbag,commodity WHERE uid='$uid' AND cid=comid AND finished=0";
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          ...
          <form action="getInOrder.php" method="post">
          <input type="number" name="quantity" min="1" max="<?php echo $row['quantity'] ?>" value="1" >庫存: <?php echo $row['quantity'] ?>
          </form>
        ...
        <div class="panel-footer">
          ...
          <input type="button" name="button" value="刪除" onclick="location.href='deleteCom.php?value='+<?php echo $row['cid'] ?>" style="color:#FFB7DD">                  
          </form>
        </div>
      </div>      
    </div>   
...
<form action="getInOrder.php" method="post">
  <center><input type="submit" name="button" value="結帳" style="color:#FFB7DD"></center>                  
</form>
