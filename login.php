...
<div style="text-align:center;margin:0px auto;">
	...
	<input type="text" style="width: 50%;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;box-sizing: border-box;" name="username" required="TRUE" placeholder="請輸入帳號"/><br>
	<input type="password" name="pw" required="TRUE" placeholder="請輸入密碼"/><br>
  
    <input type="submit" value="登入"/><br>
	<a href="register.php">會員註冊</a>
	<a href="forget_reset.php">忘記密碼?</a>
	</form>
...
<?php
	...
	if(isset($username) && isset($pw)){
       $sql ="SELECT id,Username,Password,Name,Gender FROM user WHERE Username='$username'";                    
